...
const CheckoutSuccess = () => {
  ...
  useEffect(() => {
    ...
    meta.content =
      "Thank you for your order! Your order will be processed within 24 hours.";
    ...
    <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <div className="mx-auto max-w-xl px-4 2xl:px-0 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full">
          <Button className="w-full md:w-1/2" onClick={() => navigate("/user/orders")}>Track your order</Button>
          <Link
            to="/products"
